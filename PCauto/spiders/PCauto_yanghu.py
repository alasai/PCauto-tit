...
from PCauto.items import PCautoYanghuItem

class PCautoYanghuSpider(RedisSpider):
    name = 'PCauto_yanghu'
    index_page = 'http://www.pcauto.com.cn/drivers/'

    pipeline = set([pipelines.YanghuPipeline, ])
