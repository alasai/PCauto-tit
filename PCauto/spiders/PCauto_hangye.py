...
from PCauto.items import PCautoHangyeItem

class PCautoHangyeSpider(RedisSpider):
    name = 'PCauto_hangye'
    index_page = 'http://www.pcauto.com.cn/news/'

    pipeline = set([pipelines.HangyePipeline, ])
