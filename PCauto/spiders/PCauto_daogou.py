...
from PCauto.items import PCautoDaogouItem

class PCautoDaogouSpider(RedisSpider):
    name = 'PCauto_daogou'
    index_page = 'http://www.pcauto.com.cn/teach/'

    pipeline = set([pipelines.DaogouPipeline, ])
