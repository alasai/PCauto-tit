...
from PCauto.items import PCautoTechItem

class PCautoTechSpider(RedisSpider):
    name = 'PCauto_tech'
    index_page = 'http://www.pcauto.com.cn/tech/'

    pipeline = set([pipelines.TechPipeline, ])
